...
const Welcome = (onNavigate2) => {
  ...
  logo.setAttribute("src", "/assets/media/logo-blanco-fems-viajando-juntas.png");
  ...
  imgGoogle.setAttribute("src", "/assets/media/logo-google.png");
...
const Signup = (onNavigate2) => {
  ...
  labelPassword.textContent = "Contrase\xF1a";
  errorPassword.textContent = "La contrase\xF1a tiene que ser de 4 a 12 d\xEDgitos.";
  ...
  function register() {
    const email = inputEmail.value;
    const password = inputPassword.value;
    registerNewUser(email, password).catch((error) => {
      alert(error.message);
    }).then(() => {
      verifyEmail();
      onNavigate2("/login");
...
const Home = (onNavigate2) => {
  ...
  title.textContent = "P\xE1gina de Inicio";
